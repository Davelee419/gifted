...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "Gifted~yjwhwRQC#UH0EoHtZpzLWNO-Tjf1PCCRmtgs2SWBLyoHUpQv1_G0", // Add sess Id here espwcially when deploying on panels else use app.json and .env file...
SUDO_NUMBERS: process.env.SUDO_NUMBERS || "19293468963", //Add multiple Numbers with Country Codes without (+) Separated by Comma...
...
OWNER_NAME: process.env.OWNER_NAME || "DAVE LEE", // Input Yours custom...(Maintain font for Flow)
...
TIME_ZONE: process.env.TIME_ZONE || "Nigeria/Lagos", // Enter yours else leave blank if not sure
};
